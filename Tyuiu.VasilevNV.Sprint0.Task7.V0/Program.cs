...
namespace Tyuiu.VasilevNV.Sprint0.Task7.V0
{
    ...
    class Program
    {
        ...
        {
            Console.Title = "Спринт #0 | Выполнил: Васильев Н. В. | ИСПБ-24-1";
            Console.WriteLine("*************************************************************************");
            ...
            {
                Console.WriteLine("Ошибка! Исходящие массивы имеют разное количество элементов");
            }
            Console.ReadKey();
        }
    }
